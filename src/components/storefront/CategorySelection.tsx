...
import men from "/public/assets/man-shoes.jpg";
import women from "/public/assets/women-shoes.png";
  ...
  return (
    <div className="py-24 sm:py-32">
      ...
      <div className="mt-6 grid grid-cols-1 gap-y-6  sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6  lg:gap-8">
        <div className="group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:aspect-w-1 sm:row-span-2">
          <Image
            src={all}
            alt="all products"
            width={1000}
          ...
          <div className="p-6 flex items-end">
            <Link href="/products/all">
              ...
              <p className="mt-1 text-sm text-white">Show Now</p>
            </Link>
          </div>
        </div>
        ...
        <div className="group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:relative sm:aspect-none sm:h-full">
          <Image
            ...
            width={1000}
            height={1000}
            className=" object-cover sm:absolute sm:inset-0 sm:w-full sm:h-full"
          />
          <div className="bg-gradient-to-b from-transparent to-black opacity-55 sm:absolute sm:inset-0" />
          <div className="p-6 flex items-end sm:absolute sm:inset-0">
            <Link href="/products/all">
